...
!!    Srin co2 (EPA)
      ...
      if (eof < 0) exit   !HR 23Dec2020
      read (103,*,iostat=eof) pestgwfactor !HR 23Dec2020
      if (eof < 0) exit   
      read (103,*,iostat=eof) pestgwdeepfactor !HR 04Jan2020
      if (eof < 0) exit   
      read (103,*,iostat=eof) pstuptk !HR 28Dec2022
      exit
!!    Drainmod input variables - 01/2006
      end do
...
!!    mike van liew additions for basins.bsn
      ...
      if (pestgwfactor <= 1.e-6) pestgwfactor=0.02 !HR 23Dec2020
      if (pestgwdeepfactor <= 1.e-6) pestgwdeepfactor=0.02 !HR 23Dec2020
      if (pstuptk <= 1.e-6) pstuptk=0.0 !HR 28Dec2022
