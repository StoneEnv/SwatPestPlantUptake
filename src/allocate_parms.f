...
!!    arrays which contain data related to soil layers, HRUs, pesticides
      ...
      allocate (sol_pst_conc(mpst,mhru,mlyr)) !HR 12/2022
      allocate (wuse(mlyr)) !HR 12/2022
      allocate (plt_pst2(mpst,mhru)) !HR 12/2022
      allocate (plt_upst_d(mpst,mhru)) !HR 12/2022
      allocate (plt_upst_ly(mpst,mlyr)) !HR 12/2022
...
!!    arrays which contain data related to pesticides, HRUs
      allocate (conc1(mpst)) !HR
      allocate (conc2(mpst)) !HR
      allocate (conc3(mpst)) !HR
      allocate (conc4(mpst)) !HR
      allocate (conc5(mpst)) !HR
      allocate (conc6(mpst)) !HR  
      ...
      allocate (tile_pst(mpst)) !HR
      allocate (pst_rchrg(mpst,mhru)) !HR
      allocate (rootzpest(mpst,mhru)) !HR
      allocate (pst_shallst(mpst,mhru)) !HR
      allocate (pst_gw(mpst,mhru)) !HR
      allocate (pst_deepst(mpst,mhru)) !HR
      allocate (pst_gwdeep(mpst,mhru)) !HR

      allocate (zdb(mpst,mhru))

      !allocate (pst_lag(mpst,3,mhru))
      allocate (pst_lag(mpst,4,mhru)) !HR
...
!!    arrays which contain data related to HRU output 
      ...
      !hendrik 1/2017
      !allocate (hrupsta(mpst,5,mhru))
      !allocate (hrupstd(mpst,5,mhru))
      !allocate (hrupstm(mpst,5,mhru))
      !allocate (hrupsty(mpst,5,mhru))
      !hendrik 1/2017
      !hendrik 1/2017
      allocate (hrupsta(mpst,9,mhru))
      allocate (hrupstd(mpst,9,mhru))
      allocate (hrupstm(mpst,9,mhru))
      allocate (hrupsty(mpst,9,mhru))
      !hendrik 1/2017
...
!!    arrays
   ...
   !   allocate (hhprecip(24))
      ...
      allocate (hsedinorg(nstep)) !HR_2019 sediment beginning of timestep
      ...
      !hendrik 1/2017
      allocate (wpstaao(mpst,9))
      allocate (wpstmono(mpst,9))
      allocate (wpstyro(mpst,9))
      allocate (wpstdayo(mpst,9))
      !hendrik 1/2017
