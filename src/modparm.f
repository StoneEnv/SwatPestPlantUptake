...
!    Drainmod tile equations  01/2006
      ...
      real*8, dimension (:,:,:), allocatable :: sol_pst_conc !HR 12/2022 (for plant uptake)
      real*8, dimension (:), allocatable :: wuse !HR 12/2022
      real*8, dimension (:,:), allocatable :: plt_pst2, plt_upst_d, plt_upst_ly !HR 12/2022
...
!    Drainmod tile equations  01/2006
      ...
      real*8 :: sedinorg !HR sediment mass at beginning of timestep 
      real*8, dimension (:), allocatable :: tile_pst !HR pesticide tile and gw routing
      real*8 :: pestgwfactor, pestgwdeepfactor, pstuptk !HR 23Dec2020, 04Jan2021, 28Dec2022
      real*8, dimension(:), allocatable :: conc1, conc2, conc3, conc4, conc5, conc6
      real*8, dimension (:,:), allocatable :: pst_rchrg, rootzpest !HR pesticide tile and gw routing
      real*8, dimension (:,:), allocatable :: pst_shallst, pst_gw !HR pesticide tile and gw routing
      real*8, dimension (:,:), allocatable :: pst_deepst, pst_gwdeep !HR pesticide tile and gw routing
      integer, dimension (:), allocatable :: vfshru !HR/cibin VFS
      integer, dimension (:,:), allocatable :: filter_HRU !HR/cibin VFS
...
! hourly time step (by AVG)
      ...
      real*8, dimension (:), allocatable :: hsedinorg !HR_2019 sediment beginning of timestep
