...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      character(len=7) :: aax7
      character(len=8) :: aax8
      ...
      character(len=7) :: aax71
      character(len=8) :: aax81
...
!! write headings to pesticide output file (output.pst) !HR modified to add lateral, tile and gw output
     ...
     &                values(6), values(7)
        write (30,1010) title
        write (30,3000)
        write (30,3001) (npno(j),npno(j),
     &                   npno(j),npno(j),
     &                   npno(j),npno(j),
     &                   npno(j),npno(j), j = 1, npmx)
     ...
     &                   pname(npno(j)),pname(npno(j)), j = 1, npmx)
        ...
        aax7="Soil_mg"
        aax8="Plant_mg"
      write (30,3003) ((aax1,aax2,aax3,aax4,aax5,aax6,aax7,aax8), j = 1, npmx)
      end if
!! write headings to pesticide conc output file (outputconc.pst) !HR 
     ...
     &                values(6), values(7)
        ...
        write (32168,3000)
        write (32168,3001) (npno(j),npno(j),npno(j),npno(j),npno(j),npno(j),npno(j),npno(j),
     &         j = 1, npmx)
     ...
     &                   pname(npno(j)),pname(npno(j)), j = 1, npmx)
      ...
      write (32168,3003) ((aax11,aax21,aax31,aax41,aax51,aax61,aax71,aax81), j = 1, npmx)
      end if
...
!bmp-ri.out
 ...
 3001 format ("Pesticide #        ",32(15x,i3))
